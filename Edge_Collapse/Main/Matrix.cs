...
namespace Edge_Collapse
{
    class Matrix
    {
        ...
        public static double[,] SubstructMatrices(double[,] i_A, double[,] i_B)
        {
            int rows = i_A.GetLength(0);
            int cols = i_A.GetLength(1);
            ...
            for (int i = 0; i < rows; i++)
            {
                ...
                {
                    result[i, j] = i_A[i, j] - i_B[i, j];
                }
            }

            return result;
        }
        public static double[,] AddMatrices(double[,] i_A, double[,] i_B)
        {
            int rows = i_A.GetLength(0);
            int cols = i_A.GetLength(1);
            double[,] result = new double[rows, cols];
